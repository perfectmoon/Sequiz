                        ...
                        <div className="flex flex-col items-center justify-center w-full h-[100%] gap-2">
                            ...
                            className="w-[80%] h-[70%] p-4 text-white text-2xl bg-green-800/70 rounded-2xl [-webkit-text-stroke:0.3px_green] outline-3 font-extralight shadow-2xl">
                                ...
                                transition={{duration:0.4, ease:'easeInOut'}} className="text-wrap">
                                    Learning CyberSecurity Through Education Game is a final-year project developed by three students from Bina Nusantara University (BINUS), School of Computer Science.

Instead of a single, linear learning path, we built three independent game modules—each focusing on a different way to understand cybersecurity concepts. You can jump into any module at any time, with no dependencies or unlock requirements.
