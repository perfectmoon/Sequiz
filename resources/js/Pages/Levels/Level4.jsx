...
export default function Level4({ level, hints, usedHints, csrfToken }) {
                ...
                <div className="container mx-auto px-4 py-8">
                    <div className="max-w-3xl mx-auto bg-gray-800 rounded-lg shadow-2xl p-8">
                        <div className="text-center mb-8">
                            <h1 className="text-4xl font-bold mb-2">💾 Level 4: Storage Heist</h1>
                            <div className="flex justify-center space-x-4 text-sm">
                                <span className="bg-yellow-600 px-3 py-1 rounded-full">{level.difficulty || 'Medium'}</span>
                                <span className="bg-gray-700 px-3 py-1 rounded-full">{level.time_estimate || '15 mins'}</span>
                        ...
                        <div className="mt-8">
                            <input 
                                ...
                                autoComplete="off"
                            />
                            <button onClick={checkAnswer} className="w-full bg-orange-600 hover:bg-orange-700 text-white font-bold py-3 rounded-lg mb-4">
                                Submit Answer
                            </button>
